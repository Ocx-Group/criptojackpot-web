...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'CriptoJackpot — Promociones con Cripto',
    description:
      'Descubre, juega y gana con CriptoJackpot. Participa en promociones con criptomonedas, elige tus números de la suerte y gana premios.',
  },
};
...
const jsonLd = {
  ...
  description: 'Plataforma de promociones con criptomonedas. Elige tus números, refiere amigos y gana premios.',
  potentialAction: {
    '@type': 'SearchAction',
...
const howItWorksJsonLd = {
  ...
  description: 'Guía paso a paso para participar en promociones con criptomonedas en CriptoJackpot.',
  step: [
    {
      '@type': 'HowToStep',
      position: 1,
      name: 'Elige Tu Ticket',
      text: 'Explora nuestras promociones activas, elige la que más te guste y selecciona tus números de la suerte. ¡Completa tu compra y ya estás participando!',
    },
    {
      '@type': 'HowToStep',
      position: 2,
