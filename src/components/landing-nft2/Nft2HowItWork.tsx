...
const Nft2HowItWork = () => {
  ...
  return (
    <section className="howit-work-section howit-work-sectionv9 position-relative bg1-color pt-120 pb-120" id="down-scroll">
      {/* <!--Section Header--> */}
        ...
        <div className="row g-6">
          <MotionFade className="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1000">
            <div className="work-item1 work-itemv14 position-relative">
              <h2 className="nw1-clr mb-xxl-11 mb-xl-8 mb-lg-6 mb-5">
                <span className="d-block">{t('HOW_IT_WORK.step1Title1')}</span>
                <span>{t('HOW_IT_WORK.step1Title2')}</span>
              </h2>
              <p className="fs18 nw2-clr">{t('HOW_IT_WORK.step1Desc')}</p>
