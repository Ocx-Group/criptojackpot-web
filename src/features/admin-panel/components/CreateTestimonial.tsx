...
const CreateTestimonial: React.FC = () => {
  const { formData, isSubmitting, handleInputChange, handleSubmit } = useCreateTestimonialForm();
            ...
            <form onSubmit={handleSubmit} className="row g-4">
              ...
              <div className="col-md-12">
                ...
                <div className="form-text">
                  {t('TESTIMONIALS_ADMIN.help.authorImageUrl', 'URL de la foto del autor (opcional)')}
                </div>
              </div>
